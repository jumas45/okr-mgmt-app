...
const FloatingLabelTextarea = React.forwardRef<HTMLTextAreaElement, FloatingLabelTextareaProps>(
  ({ label, value, onChange, name, required, error, ...props }, ref) => {
    ...
    return (
      <div className="relative w-full">
        <textarea
          ...
          required={required}
          className={`block w-full px-3 py-2 bg-transparent border rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:shadow-lg transition-all duration-200 resize-none
